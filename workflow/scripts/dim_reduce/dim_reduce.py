...
class DimReduce:
    ...
    @staticmethod
    def tsne(adata: AnnData, perplexity = 1000, 
             learning_rate=1000, **kwargs) -> AnnData:
        ...
        # Apply tSNE to the data
        sc.tl.tsne(adata_copy, perplexity=perplexity, 
    ...
    def umap(adata: AnnData, 
        ...
        sc.tl.umap(adata, neighbors_key="neighbors_umap",
                  min_dist=min_dist, n_components=n_comps, **kwargs)
...
def main(snakemake) -> None:
    ...
    adata_dim_reduce = DimReduce(adata, 
                                 snakemake.wildcards.dr_method,
